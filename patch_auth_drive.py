...
# Fix authorize validation
drive_content = re.sub(
    r"if \(\!prompt && accessToken && Date\.now\(\) < tokenExpiresAt\) return accessToken;",
...
# Make auth.tsx clear drive token on sign out
